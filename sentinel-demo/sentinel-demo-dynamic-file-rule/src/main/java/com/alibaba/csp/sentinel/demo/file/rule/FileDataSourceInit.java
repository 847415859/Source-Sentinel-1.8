 ...
 * </p>
 *
 * 展示如何通过 Sentinel init SPI 机制注册可读可写数据源的示例。
 * 要激活此功能，您可以将类名添加到资源目录的“META-INF/services/”目录中的
 * “com.alibaba.csp.sentinel.init.InitFunc”文件中。
 * 那么Sentinel初始化的时候就会自动注册数据源。
 *
 * @author Eric Zhao
 */
